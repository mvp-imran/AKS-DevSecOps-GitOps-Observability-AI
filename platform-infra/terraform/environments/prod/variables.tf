variable "resource_group_name" {
  description = "The Resource Group name for PROD resources"
  type        = string
  default     = "rg-platform-prod-eus"
}

variable "location" {
  description = "The Azure region for PROD deployment"
  type        = string
  default     = "eastus"
}
